<!-- Fuente: https://www.freqtrade.io/en/stable/strategy-advanced/ -->

# Advanced Strategies

This page explains some advanced concepts available for strategies.
If you're just getting started, please familiarize yourself with the [Freqtrade basics](../bot-basics/) and methods described in [Strategy Customization](../strategy-customization/) first.

The call sequence of the methods described here is covered under [bot execution logic](../bot-basics/#bot-execution-logic). Those docs are also helpful in deciding which method is most suitable for your customisation needs.
...
user\_data/strategies/myawesomestrategy.py
...
user\_data/strategies/MyAwesomeStrategy2.py
