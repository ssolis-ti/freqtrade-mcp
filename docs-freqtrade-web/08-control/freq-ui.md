<!-- Fuente: https://www.freqtrade.io/en/stable/freq-ui/ -->
...
FreqUI does not have it's own configuration file - but assumes a working setup for the [rest-api](../rest-api/) is available.
...
![FreqUI - login](https://www.freqtrade.io/en/stable/assets/frequi-login-CORS.png#only-dark)
![FreqUI - login](https://www.freqtrade.io/en/stable/assets/frequi-login-CORS-light.png#only-light)
...
![FreqUI - trade view](https://www.freqtrade.io/en/stable/assets/freqUI-trade-pane-dark.png#only-dark)
![FreqUI - trade view](https://www.freqtrade.io/en/stable/assets/freqUI-trade-pane-light.png#only-light)
...
![FreqUI - plot configuration](https://www.freqtrade.io/en/stable/assets/freqUI-plot-configurator-dark.png#only-dark)
![FreqUI - plot configuration](https://www.freqtrade.io/en/stable/assets/freqUI-plot-configurator-light.png#only-light)
...
![FreqUI - Settings view](https://www.freqtrade.io/en/stable/assets/frequi-settings-dark.png#only-dark)
![FreqUI - Settings view](https://www.freqtrade.io/en/stable/assets/frequi-settings-light.png#only-light)

## Webserver mode

when freqtrade is started in [webserver mode](../utils/#webserver-mode) (freqtrade started with `freqtrade webserver`), the webserver will start in a special mode allowing for additional features, for example:
...
When freqtrade is started in [webserver mode](../utils/#webserver-mode) (freqtrade started with `freqtrade webserver`), the backtesting view becomes available.
...
![FreqUI - Backtesting](https://www.freqtrade.io/en/stable/assets/freqUI-backtesting-dark.png#only-dark)
![FreqUI - Backtesting](https://www.freqtrade.io/en/stable/assets/freqUI-backtesting-light.png#only-light)
