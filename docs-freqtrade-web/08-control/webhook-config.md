<!-- Fuente: https://www.freqtrade.io/en/stable/webhook-config/ -->
...
![discord-notification](https://www.freqtrade.io/en/stable/assets/discord_notification.png)

Custom messages can be sent from a strategy to Discord endpoints via the dataprovider.send\_msg() function. To enable this, set the `allow_custom_messages` option to `true`:
