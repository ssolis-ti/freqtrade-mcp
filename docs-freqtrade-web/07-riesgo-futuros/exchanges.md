<!-- Fuente: https://www.freqtrade.io/en/stable/exchanges/ -->
...
| --- | --- | --- | --- |
| [Binance](./#binance) | spot |  | limit |
| [Binance](./#binance) | futures | isolated, cross | market, limit |
| [Bingx](./#bingx) | spot |  | market, limit |
| [Bitmart](./#bitmart) | spot |  | ❌ (not available) |
| [Bitget](./#bitget) | spot |  | market, limit |
| [Bitget](./#bitget) | futures | isolated | market, limit |
| [Bybit](./#bybit) | spot |  | ❌ (not available) |
| [Bybit](./#bybit) | futures | isolated | market, limit |
| [Gate.io](./#gateio) | spot |  | limit |
| [Gate.io](./#gateio) | futures | isolated | limit |
| [HTX](./#htx) | spot |  | limit |
| [Hyperliquid](./#hyperliquid) | spot |  | ❌ (not available) |
| [Hyperliquid](./#hyperliquid) | futures | isolated, cross | limit |
| [Kraken](./#kraken) | spot |  | market, limit |
| [Kraken](./#kraken-futures) | futures | isolated | market, limit |
| [OKX](./#okx) | spot |  | market, limit |
| [OKX](./#okx) | futures | isolated | market, limit |
| [Bitvavo](./#bitvavo) | spot |  | ❌ (not available) |
| [Kucoin](./#kucoin) | spot |  | market, limit |
...
Binance supports [time\_in\_force](../configuration/#understand-order_time_in_force).
...
![Binance futures settings](https://www.freqtrade.io/en/stable/assets/binance_futures_settings.png)
...
BingX supports [time\_in\_force](../configuration/#understand-order_time_in_force) with settings "GTC" (good till cancelled), "IOC" (immediate-or-cancel) and "PO" (Post only) settings.
...
Kraken supports [time\_in\_force](../configuration/#understand-order_time_in_force) with settings "GTC" (good till cancelled), "IOC" (immediate-or-cancel) and "PO" (Post only) settings.
...
> **📌 Flex (Multi-collateral) Accounts**
>
...
Kucoin supports [time\_in\_force](../configuration/#understand-order_time_in_force) with settings "GTC" (good till cancelled), "FOK" (full-or-cancel) and "IOC" (immediate-or-cancel) settings.
...
Gate.io supports [time\_in\_force](../configuration/#understand-order_time_in_force) with settings "GTC" (good till cancelled), and "IOC" (immediate-or-cancel) settings.
...
Bybit supports [time\_in\_force](../configuration/#understand-order_time_in_force) with settings "GTC" (good till cancelled), "FOK" (full-or-cancel), "IOC" (immediate-or-cancel) and "PO" (Post only) settings.
...
Bitget supports [time\_in\_force](../configuration/#understand-order_time_in_force) with settings "GTC" (good till cancelled), "FOK" (full-or-cancel), "IOC" (immediate-or-cancel) and "PO" (Post only) settings.
...
> **📌 Performance and Rate Limit Impact**
>
...
Whether your exchange returns incomplete candles or not can be checked using [the helper script](../developer/#incomplete-candles) from the Contributor documentation.

Due to the danger of repainting, Freqtrade does not allow you to use this incomplete candle.

However, if it is based on the need for the latest price for your strategy - then this requirement can be acquired using the [data provider](../strategy-customization/#possible-options-for-dataprovider) from within the strategy.
