<!-- Fuente: https://www.freqtrade.io/en/stable/data-download/ -->
...
> **📌 Kraken user**
>
> Kraken users should read [this](../exchanges/#historic-kraken-data) before starting to download data.
>
...
Great, you now have some data downloaded, so you can now start [backtesting](../backtesting/) your strategy.