<!-- Fuente: https://www.freqtrade.io/en/stable/utils/ -->
...
> **📌 Warning**
>
> Only vital questions are asked. Freqtrade offers a lot more configuration possibilities, which are listed in the [Configuration documentation](../configuration/#configuration-parameters)
...
Especially useful with [split configuration files](../configuration/#multiple-configuration-files) or [environment variables](../configuration/#environment-variables), where this command will show the merged configuration.

![Show config output](https://www.freqtrade.io/en/stable/assets/show-config-output.png)
...
Use the `test-pairlist` subcommand to test the configuration of [dynamic pairlists](../plugins/#pairlists).
...
Show whitelist when using a [dynamic pairlist](../plugins/#pairlists).
...
Please refer to the [corresponding documentation](../advanced-setup/#use-a-different-database-system) to learn about requirements for different database systems.
...
More details in the [Backtesting analysis](../advanced-backtesting/#analyze-the-buyentry-and-sellexit-tags) Section.
