<!-- Fuente: https://www.freqtrade.io/en/stable/sql_cheatsheet/ -->
...
>
> To use other Database Systems like PostgreSQL or MariaDB, you can use the same queries, but you need to use the respective client for the database system. [Click here](../advanced-setup/#use-a-different-database-system) to learn how to setup a different database system with freqtrade.
...
> **📌 Note**
>
> This should not be necessary after /forceexit, as force\_exit orders are closed automatically by the bot on the next iteration.
