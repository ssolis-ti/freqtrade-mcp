<!-- Fuente: https://www.freqtrade.io/en/stable/plotting/ -->
...
>
> Please use [FreqUI](../freq-ui/) for plotting needs, which doesn't struggle with the same performance problems.
...
![plot-dataframe](https://www.freqtrade.io/en/stable/assets/plot-dataframe.png)
...
![plot-dataframe2](https://www.freqtrade.io/en/stable/assets/plot-dataframe2.png)
...
![plot-profit](https://www.freqtrade.io/en/stable/assets/plot-profit.png)
...
The forth graph can help you analyze trade parallelism, showing how often max\_open\_trades have been maxed out.
