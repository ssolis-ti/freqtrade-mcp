<!-- Fuente: https://www.freqtrade.io/en/stable/bot-usage/ -->
...
You can add the entry "user\_data\_dir" setting to your configuration, to always point your bot to this directory.
