<!-- Fuente: https://www.freqtrade.io/en/stable/faq/ -->

# Freqtrade FAQ

## Supported Markets

Freqtrade supports spot trading, as well as futures trading for some selected exchanges. Please refer to the [documentation start page](../#supported-futures-exchanges) for an up-to-date list of supported exchanges.
...
Please make sure to read the [relevant documentation page](../leverage/) first.
...
Futures trading is supported for selected exchanges. Please refer to the [documentation start page](../#supported-futures-exchanges) for an up-to-date list of supported exchanges.
...
You can however use the [`adjust_trade_position()` callback](../strategy-callbacks/#adjust-trade-position) to adjust an open position.
...
of course constantly aim to improve the bot but it will *always* be a
...
You can use "current" market data by using the [dataprovider](../strategy-customization/#orderbookpair-maximum)'s orderbook or ticker methods - which however cannot be used during backtesting.
...
Please look at the [advanced setup documentation Page](../advanced-setup/#running-multiple-instances-of-freqtrade).
...
If you're on an older version, please follow the [upgrade instructions](../updating/) and see if your problem has already been addressed.
