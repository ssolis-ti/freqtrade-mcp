<!-- Fuente: https://www.freqtrade.io/en/stable/bot-basics/ -->
...
- **Realized Profit**: Already realized profit. Only relevant in combination with [partial exits](../strategy-callbacks/#adjust-trade-position) - which also explains the calculation logic for this.
...
- Download OHLCV data for the pairlist including all [informative pairs](../strategy-customization/#get-data-for-non-tradeable-pairs)  
...
[backtesting](../backtesting/) or [hyperopt](../hyperopt/) do only part of the above logic, since most of the trading operations are fully simulated.
